...
- System's memory (RAM, cache memory, frequency): 

When expanding RAM memory, the RAM frequency must be compatible with both the CPU and motherboard specifications.
